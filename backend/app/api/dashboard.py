...
async def get_statistics(
    ...
    """获取任务、图片、目标、耗时及环比统计，支持时间段与缺陷类别过滤。"""
    _validate_range(start_date, end_date)
    return dashboard_service.get_statistics(
        db, None, days, start_date, end_date, class_name
    )
...
async def get_defect_trend(
    ...
    return dashboard_service.get_defect_trend(
        db, None, days, start_date, end_date, class_name, top_n
    )
...
async def get_defect_options(
    ...
    _validate_range(start_date, end_date)
    return dashboard_service.get_defect_options(db, None, days, start_date, end_date)
...
async def get_scene_distribution(
    ...
    """获取检测任务的场景分布。"""
    _validate_range(start_date, end_date)
    return dashboard_service.get_scene_distribution(db, None, days, start_date, end_date)
...
async def get_type_distribution(
    ...
    _validate_range(start_date, end_date)
    return dashboard_service.get_type_distribution(db, None, days, start_date, end_date)
