...
async def get_statistics(
    ...
    """获取任务、图片、目标、耗时及环比统计。"""
    return dashboard_service.get_statistics(db, None, days)
...
async def get_trend(
    ...
    return dashboard_service.get_trend(db, None, days)
...
async def get_class_distribution(
    ...
    """获取检测目标类别分布。"""
    return dashboard_service.get_class_distribution(db, None, days)
...
async def get_scene_distribution(
    ...
    """获取检测任务的场景分布。"""
    return dashboard_service.get_scene_distribution(db, None, days)
...
async def get_type_distribution(
    ...
    return dashboard_service.get_type_distribution(db, None, days)
